from ._anvil_designer import composed_bending_baTemplate
from anvil import *
import anvil.server
...
class composed_bending_ba(composed_bending_baTemplate):
  def __init__(self, **properties):
    ...
    self.row_est = RowItem("εst", editable=True, row_type="param")

    self.row_eud = RowItem("εud", editable=True, row_type="param")

    self.row_ecu = RowItem("εcu", editable=True, row_type="param")
    self.row_es = RowItem("Es", editable=True, row_type="param")
    self.row_lambda = RowItem("λ", editable=True, row_type="param")

    self.row_eta = RowItem("η", editable=True, row_type="param")
